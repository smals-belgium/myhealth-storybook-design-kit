...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>boolean</code></td>
      <td>If true, shows an action button with optional loading and disabled states.</td>
      <td><code>false</code></td>
      <td>No</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>buttonLoading</code></td>
      <td><code>boolean</code></td>
      <td>If true, changes the label of the button to buttonLoadingLabel() and displays a loading icon inside the action button.</td>
      <td><code>false</code></td>
      <td>No</td>
    </tr>
    <tr>
      ...
      <td><code>string</code></td>
      <td>Label text for the action button when not loading.</td>
      <td>—</td>
      <td>No</td>
    </tr>
    <tr>
      <td><code>buttonLoadingLabel</code></td>
      <td><code>string</code></td>
      <td>Label text displayed inside the action button when in loading state.</td>
