...
> The `Alert` is a additional ui component that displays a contextual message with an icon, a alertTitle, a alertSubtitle, an optional details, action button and close button.
...
>
  Your connection is unstable. Please check your network settings.
</mh-alert>
```
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>alertSubtitle</code>
      </td>
      <td>
        <code>string</code>
      </td>
      <td>The alert alertSubtitle.</td>
      <td>—</td>
      <td>No</td>
    </tr>
    <tr>
