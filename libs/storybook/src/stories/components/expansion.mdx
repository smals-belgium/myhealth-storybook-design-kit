...
<Meta title="Angular Components/Expansion" />
...
>
> The accordion (expansion) is based of Angular Material's [expansion](https://material.angular.io/components/expansion). Material's core features will remain the same and can be implemented in the same way.
...
It allows users to quickly scan the structure of a page and expand the sections they're interested in.

### Panel accordion

A panel accordion is a visually more prominent version of a default accordion. It can be used on its own—for example, to show or hide the details of an informational alert.
