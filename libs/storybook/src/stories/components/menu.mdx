...
Use it as a menu or use it as dropdown buttons when no default action is available and more than 2 actions need to be offered.

### Disable state

- When an item in the list becomes inactive, don't change the order but make sure the disable ones are grayed out.
