...
- Migrated design-kit from Angular 19 to Angular 22.

**Deprecated features:**

- Support for Angular 19 has been deprecated. Please upgrade to Angular 22 to use the latest version of the design kit.

## 4.2.0 (6 August 2026)

**New features:**

- Added support for other font formats (woff2, woff, otf, eot, svg, ttf) when providing your own material symbols font file.

## 4.1.5 (13 April 2026)

**Bug fixes:**

- Fixed dialog mobile styles that were unintentionally removed in a previous refactor: restored surface padding, title separator, and actions border/spacing overrides for small screens.

## 4.1.4 (26 March 2026)

**Bug fixes:**

- Support shadow DOM by adding :host selector alongside html

## 4.1.3 (6 March 2026)

**New features:**

- Added a `neutral` variant for the [Snackbar component](/docs/angular-components-snackbar--docs) with a black background and white text.
  Use `panelClass: 'mh-snackbar--neutral'` when opening the snackbar.

## 4.1.2 (2 March 2025)

**Bug fixes:**

- Fixed an issue where the default `mat-label` was partially cut off due to a wrongful z-index.

## 4.1.1 (13 February 2025)

**Bug fixes:**

- Fixed the issue where the background of the form field had become transparent.
- Fixed issue with the new table styling where the details row was not expanding correctly.

**Updated documentation:**

- Wrongful neutral border color tokens in [Color Tokens documentation](/docs/foundations-color-tokens--docs) have been fixed to match the design system.
- Fixed an issue in the Storybook docs where the table was still using the now deprecated expandable table implementation, instead of the new implementation introduced in version 4.1.0.

## 4.1.0 (10 February 2025)
...
- Added documentation on how to use textual prefix and Suffix in [Form Field component](/docs/angular-components-form-field--docs) documentation.
- Added entirely new styling for material tables.
  Please make sure to implement the new expandable table as described in the [Table documentation](/docs/angular-components-table--docs).
  Also make sure to implement the icon in the sortable column headers, as described in the documentation.
  The new implementation improves accessibility and usability.
- Added dcoumentation to add a character counter to the textarea input field, as described in the [Form Field documentation](/docs/angular-components-form-field--docs).

**Fixed bugs:**

- Fixed styling inconsistencies for dialog component.
- Got rid of deprecated color tokens in components.

**Deprecated features:**

- Deprecated typography color tokens: `$typography-semantic-success` and `$typography-semantic-warning`.
...
- Deprecated typography color token: `$typography-brand-neutral-light`.
  This token is no longer used in the design system and has been removed to prevent confusion.
- Deprecated expandable table implementation in favor of the new implementation introduced in version 4.1.0.
  The new implementation offers improved accessibility and usability.
  Please refer to the updated [Table documentation](/docs/components-table--docs) for guidance on using the new expandable table.
